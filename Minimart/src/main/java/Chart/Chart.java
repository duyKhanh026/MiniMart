...
public class Chart extends PanelBorder {

    private List<ModelLegend> legends = new ArrayList<ModelLegend>();
    private List<ModelChart> model = new ArrayList<ModelChart>();
