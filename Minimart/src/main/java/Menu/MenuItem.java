        ...
        layout.setHorizontalGroup(
        	layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(layout.createSequentialGroup()
        			...
        			.addComponent(lbIcon)
        			.addGap(18)
        			.addComponent(lbName, GroupLayout.PREFERRED_SIZE, 99, GroupLayout.PREFERRED_SIZE)
        			.addContainerGap(114, Short.MAX_VALUE))
        );
        layout.setVerticalGroup(
        	layout.createParallelGroup(Alignment.LEADING)
        		.addComponent(lbIcon, GroupLayout.DEFAULT_SIZE, 50, Short.MAX_VALUE)
        		.addComponent(lbName, GroupLayout.DEFAULT_SIZE, 50, Short.MAX_VALUE)
        );
