...
public class CreateAcc {
	...
	public static void showPanel1(final JFrame framet, final JPanel firstPanel) {
		...
		userNameText.setBounds(300, 149, 629, 61);
		...
		passwordField.setBounds(300, 255, 629, 61);
		...
		passwordField_1.setFont(new Font("Tahoma", Font.PLAIN, 34));
		passwordField_1.setBorder(null);
		passwordField_1.setBounds(300, 361, 629, 61);
		...
		EmailText.setFont(new Font("Tahoma", Font.PLAIN, 34));
		EmailText.setBorder(null);
		EmailText.setBounds(300, 467, 629, 61);
