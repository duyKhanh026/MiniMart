...
public class ProductTable extends JPanel{
	...
	private void initialize(final Main maint) {
		...
		btn_search.setBounds(321, 70, 144, 38);
	    ...
	    list_product.setBounds(21, 68, 287, 39);
		...
		JComboBox Loaisp = new JComboBox(loai);
		Loaisp.setFont(new Font("Tahoma", Font.PLAIN, 25));
		Loaisp.setBounds(212, 68, 279, 39);
