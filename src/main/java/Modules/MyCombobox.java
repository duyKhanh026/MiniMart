...
public class MyCombobox<E> extends JComboBox<E>{
    ...
    public void setBtColor(Color lineColor) {
        this.btColor = lineColor;
    }

    private String labeText = "Label";
    private Color lineColor = new Color(3, 155, 216);
    private Color btColor = new Color(240, 240, 240);
    private boolean mouseOver;

    @SuppressWarnings({ "unchecked", "rawtypes" })
	public MyCombobox(String[] strt) {
        setBackground(Color.WHITE);
        setBorder(new EmptyBorder(15, 3, 5, 3));
        setUI(new ComboUI(this));
        setModel(new javax.swing.DefaultComboBoxModel(strt));
    ...
    private class ComboUI extends BasicComboBoxUI {
		...
		public ComboUI(final MyCombobox combo) {
            this.combo = combo;
            addMouseListener(new MouseAdapter() {
                @Override
                public void mouseEntered(MouseEvent me) {
                    mouseOver = true;
                    arrowButton.setBackground(combo.getLineColor());
                    repaint();
                }
